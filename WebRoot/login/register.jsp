...
<html>
  <head lang="en">
    ...
    <link rel="stylesheet" href="/javaweb_project2/login/css/all.css"/>
    <script src="/javaweb_project2/login/js/my.js"></script>
    <script>
        // 1、获得焦点，内容为空，tip默认提示
        // 2、失去焦点，内容为空，tip为隐藏
  ...
  <body>
    ...
    <div class="container">
    	...
    	<div class="register">
    		<!--用户名-->
    		<form action="/javaweb_project2/register" method="get" id="form_register">
    		<div class="register-box">
    			<!--表单项-->
    			<form action="">
    			<div class="box default">
    				<label for="userName">用&nbsp;户&nbsp;名</label>
    				<input type="text" id="userName" name="username" placeholder="您的账户名和登录名" /><span style="color:red;" id="nameRepeat">${nameRepeat}</span>
    				<i></i>
    			</div>
    			<!--提示信息-->
    			<div class="tip">
